#!/usr/bin/env python3
"""Synthesis-only canary for lane-diverse critical-bit replica flops."""
...
def main() -> int:
    ...
    common = (
        f"DESIGN_CONFIG={config} DESIGN_NAME=similarity_asic_transfer_preserved "
    ...
    output_dir = ROOT / "results" / "similarity_replica_preservation"
    ...
    report = (
        flow / "reports" / args.platform /
        "similarity_asic_transfer_preserved" / "base" / "synth_stat.txt"
    )
