...
# The committed LPF records the board's real 25 MHz oscillator constraint.
# For implementation-frequency characterization, remove only that FREQUENCY
# statement so nextpnr --freq supplies the timing target. Pin locations remain
# identical to the physical-board file.
