...
// Exploratory, opened-data-only intervention.
//
...
// keep attributes make the intended fanout intervention observable after
// synthesis instead of allowing identical replica registers to be merged.
module kernellum_selective_mac_array #(
