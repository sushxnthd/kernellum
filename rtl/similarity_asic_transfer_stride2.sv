...
// Source and observation structure match similarity_asic_transfer_top.sv.
// Kept separate so the frozen prior ASIC transfer RTL cannot change.
`ifndef ASIC_ROWS
`define ASIC_ROWS 4
`endif
`ifndef ASIC_COLS
...
module similarity_asic_transfer_stride2 #(
